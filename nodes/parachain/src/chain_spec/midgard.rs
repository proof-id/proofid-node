...
use midgard_runtime::{
	...
	ParachainInfoConfig, ParachainStakingConfig, SessionConfig, SystemConfig,
	TechnicalCommitteeConfig, VestingConfig, WASM_BINARY,
};
use midgard_runtime::pallets::MinCollatorStake;
...
pub fn load_pidnet_spec() -> Result<ChainSpec, String> {
	ChainSpec::from_json_bytes(&include_bytes!("../../res/midgardCustomSpecRaw.json")[..])
}
