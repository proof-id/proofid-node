...
use runtime_common::{
	constants::{self, PID, MICRO_PID, MILLI_PID},
	fees::ToAuthor,
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("midgard-node"),
	impl_name: create_runtime_str!("midgard-node"),
	authoring_version: 4,
	spec_version: 10310,
	impl_version: 0,
...
parameter_types! {
	...
	pub const ExistentialDeposit: Balance = 0; // TODO: Remove in production.
