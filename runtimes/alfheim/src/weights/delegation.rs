...
// --heap-pages=4096
// --output=./runtimes/alfheim/src/weights/delegation.rs
...
impl<T: frame_system::Config> delegation::WeightInfo for WeightInfo<T> {
	...
	fn revoke_delegation_root_child(r: u32, c: u32, ) -> Weight {
		(23_761_000 as Weight)
			...
			.saturating_add((19_062_000 as Weight).saturating_mul(r as Weight))
			// Standard Error: 52_000
	...
	fn revoke_delegation_leaf(r: u32, c: u32, ) -> Weight {
		(41_094_000 as Weight)
			// Standard Error: 27_000
			.saturating_add((41_000 as Weight).saturating_mul(r as Weight))
			// Standard Error: 27_000
			.saturating_add((5_758_000 as Weight).saturating_mul(c as Weight))
	...
	fn remove_delegation(r: u32, ) -> Weight {
		(63_362_000 as Weight)
			// Standard Error: 83_000
			.saturating_add((38_970_000 as Weight).saturating_mul(r as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
